...
Route::get('book/details/{id}', [HomePageController::class,'bookDetails'])->name('book_details');
Route::get('book/download/{id}', [HomePageController::class,'bookDownload'])->name('book_download');
Route::get('book/gift-coin/{id}', [HomePageController::class,'bookGiftCoin'])->name('book_gift_coin');
